...
*/
    ...
    Progress.prototype = {
        ...
        show: function show(progress) {
            ...
            // 渲染
            var $bar = this.$bar;
            if (!this._isRender && !$('.w-e-progress').length) {
            ...
            // 改变进度（节流，100ms 渲染一次）
            if (progress <= 1) {
                $('.w-e-progress').css('width', progress * 100 + '%');
            }
            if (progress == 1) {
                this._hide();
            }
 ...
 */
    ...
    UploadVideo.prototype = {
        ...
        uploadVideo: function uploadVideo(files) {
            ...
            var editor = this.editor;
            var config = editor.config;
            var uploadImgServer = '/gateway-web/application/upload';
            ...
            if (customUploadVideo && typeof customUploadVideo === 'function') {
                customUploadVideo(resultFiles[0], function(url, imgUrl) {
                    editor.cmd.do(
                        'insertHTML',
                        '<video src="' +
                            url +
    ...
    UploadImg.prototype = {
        ...
        uploadImg: function uploadImg(files) {
            ...
            if (customUploadImg && typeof customUploadImg === 'function') {
                customUploadImg(resultFiles[0], this.insertLinkImg.bind(this));
                // 阻止以下代码执行
                return;
            }
